    ...
    $.extend($.fn, {
        upload: function (settings) {
            ...
            var options = $.extend({
                ...
                uploadUrl: "/admin/user/uploadimg",      //上传URL地址
                deleteUrl: "",      //删除URL地址
                width: "",                                              //图片显示的宽度  
                height: 100,                                            //图片显示的高度  
            ...
            this.each(function () {
                ...
                $this.bind("click", function () {
                    ...
                    fileBox.html("<img src=\"/static/admin/img/loading.gif\" />   正在上传...  ");
                    ...
                    data.success = function (response, statusText, xhr, $form) {
                        ...
                        if (response) {
                            methods.showImage(response, $this.parent());
                            $this.parent().find("input:hidden").val(response);
